...
export const tourneyMapEmbed = (
    ...
    const embed = new EmbedBuilder()
        .setColor(0xff8ee6)
        .setImage(
            `https://assets.ppy.sh/beatmaps/${data.ParentSetID}/covers/cover.jpg` ??
                "https://assets.ppy.sh/beatmaps/355322/covers/cover.jpg"
        )
        ...
        .addFields({
            ...
            value: `${starRating.toFixed(2)}⭐️ - ${data.BPM * mapStats.speedMultiplier}bpm - ${
                sheetId.slice(0, -1) === "DT"
                    ? secondsToMinutes(data.TotalLength * 0.66)
